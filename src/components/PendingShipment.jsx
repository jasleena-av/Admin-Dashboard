      ...
      <div className="bg-white mt-4 rounded-lg shadow-md p-6">
        <div className="flex items-center">
          <h3 className="font-semibold gap-2 flex items-center text-2xl md:text-2xl">
            <FiTruck className="text-yellow-500" /> Pending Shipments
          </h3>
        </div>
        ...
        <div className="mt-4 flex flex-wrap  gap-3 mb-3">
          ...
          <button className="p-2 ml-10 border bg-slate-50 rounded-md flex items-center text-gray-700 gap-2">
            <TbFileExport />
            Export
          </button>
          ...
          <table className="table-auto w-full rounded-lg border border-gray-300">
            ...
            <tbody className="text-center ">
              <tr className="border-b border-gray-300 ">
                <td>
                  <select className="w-full bg-white p-2 m-2 border rounded-md">
